...
def load_trajectory_from_folder(folder_path):
    trajectories = []
    tra_folder_path = os.path.join(folder_path, 'exptraj')
...
traces = load_trajectory_from_folder(folder_path)

"""file_path = "/home/gwswdp02/data/hbc/sklearn/KG/BW.json"
...
output_feature_file = os.path.join(folder_path, 'feature', 'features_exp.csv')
